 ...
 class ProductsManagement extends React.Component {
    constructor(){
        ...
        this.state = {
            inputList: [],
            categories:[
                {"id":1, "name":"Food","products":[{"id":3, "name":"Burger","rate":10},{"id":4, "name":"Steak-Sandwich","rate":10},{"id":5, "name":"Chesse-Sandwich","rate":10}]},
                {"id":2, "name":"Drinks","products":[{"id":6, "name":"Cola-Cold","rate":0},{"id":7, "name":"Coffee-Hot","rate":0},{"id":8, "name":"Cold-Coffee","rate":0}]}
            ],
            productList:[
                {"id":3, "name":"Burger","rate":10},
                {"id":4, "name":"Steak-Sandwich","rate":10},
                {"id":5, "name":"Chesse-Sandwich","rate":10},
                {"id":6, "name":"Cola-Cold","rate":0},
                {"id":7, "name":"Coffee-Hot","rate":0},
                {"id":8, "name":"Cold-Coffee","rate":0}
            ],
            products:[
                {"id":3, "name":"Burger","rate":0,"price":'',"totalTax":'',"total":''},
            ],
            subTotal:0,
            subTotalRoundup:0,
            selectedProducts:[],
    ...
    onAddBtnClick(event){
        let newProducts = {"id":"", "name":"","rate":10,"price":'',"totalTax":'',"total":''};
            ...
            <div className="row">
                <Header title="BILL-SERVICES"/>
                        ...
                        <div className="row border">
                            ...
                            <div className="panel-heading col-md-2 text-right">TOTAL PRICE ($)</div>
                        </div>
                        <div className="panel-body" id="rowList">
                            {this.state.products.map(function(item, i){
                                return(
                                    <Row>
                                    <div className="col-md-1 form-group cursor-pointer red" onClick={this.removeProducts.bind(this,i)}>XRemove</div>
                                    <div className="col-md-1 form-group" >{i+1}</div>
                                    <div className="col-md-3 form-group">

                                            <select value={item.name} 
                                             className="form-control js-example-basic-single" ref={'pro'+i} 
                                               onChange={this.handleChangeProducts.bind(this,i)}>
                                    ...
                                    <div className="col-md-2 form-group">
                                        <input type="text" 
                                         value={this.state.price}
                                          ...
                                          autoComplete="false" 
                                          onChange={this.updatePrice.bind(this,i,item.rate)} 
                                          onFocus={this.addNewRow.bind(this,i)}/>
                                    </div>
